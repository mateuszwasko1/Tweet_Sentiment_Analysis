...
from project_name.models.predictor_baseline import PredictBaseline

bias_path = "data/bias_data/crows_pairs.csv"
...
comparison_df.to_csv("/kaggle/working/bias_data/bert_bias_comparison_baseline.csv")
